	...
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container">
			...
			<view v-else-if="showExtraIcon" class="uni-list-item__icon">
				...
				<view v-if="otherIcon" class="iconfont" 
				:class="otherIcon" :style="otherIconStyle"></view>
			...
			<!-- 	<text class="uni-list-item__content-title d-inline-block" :style="conStyle">
					{{ con }} <slot name="con"/>
				</text> -->
			...
			<view v-if="showRightSlot || showBadge || showArrow || showSwitch" :style="extraStyle" class="uni-list-item__extra">
